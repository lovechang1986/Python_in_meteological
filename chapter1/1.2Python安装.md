...
![](D:\lizm\Python_in_meteological\chapter1\pngs\anaconda_install-1.png)

2. 点击下一步，进入用户须知界面，直接`I Agree`

![](D:\lizm\Python_in_meteological\chapter1\pngs\anaconda_install-2.png)

3. 进入用户选择界面，推荐使用仅当前用户可用。这个选项无所谓，两者皆可，看个人喜好，如果没有其他要求，就直接下一步。

![](D:\lizm\Python_in_meteological\chapter1\pngs\anaconda_install-3.png)

4. 选择安装路径。

![](D:\lizm\Python_in_meteological\chapter1\pngs\anaconda_install-4.png)
...
![](D:\lizm\Python_in_meteological\chapter1\pngs\anaconda_install-5.png)
